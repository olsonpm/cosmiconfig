...
describe('cosmiconfig', () => {
  describe('search from file', () => {
    ...
    describe('without expected format', () => {
      ...
      it(
        'returns an undefined config, the file path, and isEmpty = true for an empty file, format JS',
        makeEmptyFileTest('js')
      );

      it(
        'returns an undefined config, the file path, and isEmpty = true for an empty file, format JSON',
        makeEmptyFileTest('json')
      );

      it(
        'returns an undefined config, the file path, and isEmpty = true for an empty file, format YAML',

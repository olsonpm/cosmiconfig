...
describe('cosmiconfig', () => {
  describe('search from directory', () => {
    ...
    it('returns an undefined config, file path, and isEmpty = true for empty rc file', () => {
      function readFile(searchPath) {
        switch (searchPath) {
          case absolutePath('a/b/package.json'):
          case absolutePath('a/b/.foorc'):
    ...
    it('returns an undefined config, file path, and isEmpty = true for empty .config.js file', () => {
      function readFile(searchPath) {
        switch (searchPath) {
          case absolutePath('a/b/package.json'):
          case absolutePath('a/b/.foorc'):
    ...
    describe('with rcExtensions', () => {
      ...
      it('returns an undefined config, file path, and isEmpty = true for an empty json', () => {
        function readFile(searchPath) {
          switch (searchPath) {
            case absolutePath('a/b/c/d/e/f/package.json'):
            case absolutePath('a/b/c/d/e/f/.foorc'):
      ...
      it('returns an undefined config, file path, and isEmpty = true for empty yaml', () => {
        function readFile(searchPath) {
          switch (searchPath) {
            case absolutePath('a/b/c/d/e/f/package.json'):
            case absolutePath('a/b/c/d/e/f/.foorc'):
      ...
      it('returns an undefined config, file path, and isEmpty = true for empty yml', () => {
        function readFile(searchPath) {
          switch (searchPath) {
            case absolutePath('a/b/c/d/e/f/package.json'):
            case absolutePath('a/b/c/d/e/f/.foorc'):
      ...
      it('returns an undefined config, file path, and isEmpty = true for empty js', () => {
        function readFile(searchPath) {
          switch (searchPath) {
            case absolutePath('a/b/c/d/e/f/package.json'):
            case absolutePath('a/b/c/d/e/f/.foorc'):
